...
- `Dia_del_Anio`: día consecutivo del año ($1 \le \text{Dia\_del\_Anio} \le 366$).
...
$$
AQI_i = \beta_0 + \beta_1 X_{1,i} + \beta_2 \text{Mes}_i + \beta_3 \text{Dia\_del\_Anio}_i + \beta_4 \text{Trimestre}_i + \varepsilon_i
$$
...
Los resultados obtenidos confirman una relación altamente lineal y directa entre la concentración máxima de ozono en 8 horas y el valor diario del AQI. Esto es coherente con la metodología oficial de la EPA, donde el AQI se calcula a partir de ecuaciones lineales por tramos basadas en concentraciones umbral (*breakpoints*) [2]. 
